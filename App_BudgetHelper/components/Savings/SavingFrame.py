from App_BudgetHelper.components.Savings.SavingForm import *
from App_BudgetHelper.components.Savings.SavingCard import *
...
if __name__ == '__main__':
    ...
    test_object_list = [test_saving]
    frame = SavingFrame(root,

...
def register_2_park(chromedriver_path=None, make=None, model=None, license=None, email=None):
    """
    ...
    """
    try:
        driver = webdriver.Chrome(executable_path=r"{}\chromedriver.exe".format(chromedriver_path))
        ...
        return [arg for arg in webdriverexception.args]
    except Exception as e:
        return [arg for arg in e.args]
